...
pub(super) fn is_ground(net: &str) -> bool {
...
pub(super) fn is_power_net(net: &str) -> bool {
    if is_ground(net) {
        return true;
    }
    let u = net.to_ascii_uppercase();
...
pub(super) fn is_neg_supply(net: &str) -> bool {
    let u = net.to_ascii_uppercase();
...
pub(super) fn is_connector_like(part: &str) -> bool {
