//! The AWS Bedrock **Converse** backend: a thin client over the Converse API,
//! authenticated with a bearer token (not SigV4).
//!
...
use crate::types::{Completion, ContentBlock, Message, ToolCall, ToolDef};
...
mod tests {
    use super::*;
    use crate::types::{ImageData, Role};
