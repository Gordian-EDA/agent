...
//!
//! One thing puts a symbol here: a placement that drew a sheet which did not mean
//! what the payload said falls back to [`bench`](crate::live::bench), so those
//! symbols are benched rather than the whole netlist discarded.
//! [`crate::live::arrange`] is how they leave.
//!
