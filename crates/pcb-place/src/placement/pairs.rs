...
//! ([`crate::decoupling_pairs`]/[`crate::series_pairs`]).
//!
...
use crate::{PlacementView, decoupling_pairs, series_pairs};
...
pub(crate) fn coplacement_pairs(problem: &PlacementView) -> Vec<(usize, usize)> {
